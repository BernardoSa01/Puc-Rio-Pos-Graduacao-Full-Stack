// Função para obter a lista existente no servidor via requisição GET
...
// Função para inserir um item na lista do servidor via requisição POST
...
const insertList = (nameProduct, quantity, price) => {
  let item = [nameProduct, quantity, price]
